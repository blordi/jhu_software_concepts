...
with conn.cursor() as cur:
    ...
    print("How many entries do you have in your database who have applied for Fall 2025?", cur.fetchall())
    ...
    cur.execute("""
            SELECT
                ...
                """)
    print("What percentage of entries are from international students (not American or Other)", cur.fetchall())
    ...
    cur.execute("""
            ...
            WHERE gre_aw IS NOT NULL AND gre_aw <= 6;
                """)
    print("What is the average GPA, GRE, GRE V, GRE AW of applicants who provide these metrics?", cur.fetchall())
    ...
    cur.execute("""
                ...
                gpa <= 5;
                """)
    print("What is their average GPA of American students in Fall 2025?", cur.fetchall())
    ...
    cur.execute("""
                ...
                WHERE term = 'Fall 2025';
                """)
    print("What percent of entries for Fall 2025 are Acceptances (to two decimal places)?", cur.fetchall())
    ...
    cur.execute("""
                ...
                AND gpa <= 5;
                """)
    print("What is the average GPA of applicants who applied for Fall 2025 who are Acceptances?", cur.fetchall())
    ...
    cur.execute("""
                ...
                degree = 'Masters';                
                """)
    print("How many entries are from applicants who applied to JHU for a masters degrees in Computer Science?", cur.fetchall())
    ...
    cur.execute("""
                ...
                term ILIKE '%2025%';                
                """)
    print("How many entries from 2025 are acceptances from applicants who applied to Georgetown University for a PhD in Computer Science?", cur.fetchall())
    ...
    cur.execute("""
                ...
                """)
    print("Which universities have the highest acceptance rates for interational students? How about domestic?", cur.fetchall())
    ...
    cur.execute("""
            ...
            ORDER BY degree, admission_status;        
                """)
    print("What is the average GPA of accepted students vs. rejected students by degree", cur.fetchall())